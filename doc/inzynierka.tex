...
Kazdy użytkownik w grupie posiada prawo do wypisywania listy uzytkowników w grupie oraz prawo do wykonywania czyli możliwosć wysyłania wiadomości do innych uzytkowników w ramach tej grupy oraz zapisywanie własnych danych na serwerze.
