...
Dodatkową innowacją w IFY jest obsługa zdarzeń grupowych. 
...
\begin{itemize}
\item jest zamkniętym rozwiązaniem
\item aplikacja jest płatna -- kosztuje 14,99 zł w Google Play.{tasker}
...
\subsection{IFY jako biblioteka}
