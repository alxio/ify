...
Po aktywacji recepty działa ona w tle, nasłuchując zdarzeń i reagując na nie.
\chapter{Zakończenie}
Aby zakończyć działanie recepty należy wybrać zakładkę Active recipes, wybrać ją z listy i kliknąć przycisk Disable.
Praca recepty może się też zakończyć automatyczne w wyniku wyrzucenia przez nią wyjątku lub wylogowania się użytkownika w przypadku recepty grupowej.
