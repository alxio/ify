...
Funkcjonalność ta realizowana jest poprzez możliwość rejestracji nowych użytkowników oraz łączenia ich w unikalne grupy. 
Każdy z użytkowników posiada możliwość utworzenia własnej grupy oraz dodawania do niej innych użytkowników.
Grupy charakteryzują się nazwą, która oprócz funkcji użytkowej(NIE WIEM JAK TO NAPISAĆ) pełni również funkcję niepowtarzającego identyfikatora. 
Implikuje to brak możliwości utworzenia grup o identycznych nazwach co by mogło byćmylące dla użytkowników oraz
